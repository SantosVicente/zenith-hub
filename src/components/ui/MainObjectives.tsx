...
export default function MainObjectives() {
  return (
    <div className="flex flex-col gap-24 w-full items-center">
      <h1 className="text-5xl font-semibold max-w-5xl w-full text-center">
        Quais são os principais objetivos da Zenith ?
      </h1>

      <div className="grid grid-cols-3 gap-24 text-[#14101b]">
        <div className="relative bg-zinc-200 flex flex-col gap-4 p-8 pt-24">
          ...
          <h2 className={`${InterFont.className} uppercase text-3xl font-bold`}>
            Fomentar a Inovação
          </h2>
          <p className="text-lg text-justify">
            Buscamos constantemente novas maneiras de aplicar a tecnologia para
            resolver problemas reais e impulsionar a inovação. Nosso objetivo é
            contribuir para competições e feiras científicas
          </p>
        </div>
        ...
        <div className="relative bg-zinc-200 flex flex-col gap-4 p-8 pt-24">
          ...
          <p className="text-lg text-justify">
            ...
            conhecimentos em tecnologia, preparando-os para um futuro promissor
