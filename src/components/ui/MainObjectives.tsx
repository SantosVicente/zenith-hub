  ...
  return (
    <div className="flex flex-col gap-24 w-full items-center pt-32">
      <ScrollAnimation delay={0.1} duration={0.3} y={150}>
        <h1 className="hidden md:block text-4xl 2xl:text-5xl font-semibold max-w-5xl w-full text-center">
          Quais são os principais objetivos da Zenith ?
        </h1>
      </ScrollAnimation>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-24 text-[#14101b] transform lg:scale-[.85] 2xl:scale-100">
        <ScrollAnimation delay={0.3} duration={0.3} y={150}>
          <div className="relative bg-zinc-200 flex flex-col gap-4 p-8 pt-24 h-full">
            ...
            <h2
              className={`${InterText.className} uppercase text-3xl font-bold`}
            >
              Fomentar a Inovação
            </h2>
